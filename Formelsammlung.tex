...
\parbox{\columnwidth}{\centering Jede Normalverteilung kann standisiert werden, das heißt die Kurve wird in die Mitte des Graphen verschoben}\\ \\
\parbox{\columnwidth}{\centering Wenn $X \sim N(\mu, \sigma^2)$}\\ 
\parbox{\columnwidth}{\centering dann ist $Z = \frac{x-\mu}{\sigma} \sim N(0,1)$}\\ \\
