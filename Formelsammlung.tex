...
\section{\noindent\framebox[\columnwidth][l]{Beschreibende Statistik}}
\subsection{\noindent\framebox[\columnwidth][l]{Lageparameter}}

\noindent\framebox[\columnwidth][l]{Arithmetisches Mittel}
\parbox{\columnwidth}{\centering$\bar{x}=\frac{1}{n}\sum \limits_{i=1}^n x_i=\frac{1}{n}(x_1 + \dots + a_n)$}

\noindent\framebox[\columnwidth][l]{Geometrisches Mittel}
\parbox{\columnwidth}{\centering$\bar{x}_{geom} = \sqrt[n]{x_1 \cdot x_2 \cdot \dots \cdot x_n}$}

\noindent\framebox[\columnwidth][l]{Median}
...
\subsection{\noindent\framebox[\columnwidth][l]{Streungsmaße}}

\noindent\framebox[\columnwidth][l]{(empirische) Varianz}
\parbox{\columnwidth}{\centering$var = \sigma^2 = {s_n}^2 = \frac{1}{n-1} \sum \limits_{i=1}^n(x_i-\bar{x})^2$}

\noindent\framebox[\columnwidth][l]{Standardabweichung}
\parbox{\columnwidth}{\centering$\sigma = s_n = \sqrt{\sigma^2}$}
\parbox{\columnwidth}{\centering$\sigma = s_n = \sqrt{{s_n}^2}$}

\noindent\framebox[\columnwidth][l]{mittlere absolute Abweichung}
...
\subsection{\noindent\framebox[\columnwidth][l]{Kovarianz und Korrelationskoeffizient}}

\noindent\framebox[\columnwidth][l]{Kovarianz}
\parbox{\columnwidth}{\centering$cov(x,y) = S_{xy} = \frac{1}{n-1}\sum \limits_{i=1}^1(x_i-\bar{x})\cdot(y_i-\bar{y})$}

\noindent\framebox[\columnwidth][l]{Korrelationskoeffizent}
\parbox{\columnwidth}{\centering$r_{xy} = \frac{S_{xy}}{S_x \cdot S_y}$}
Der Korrelationskoeffizent liegt immer zwischen $-1 \leq r \leq 1$

\subsection{\noindent\framebox[\columnwidth][l]{Regressionsrechnung}}

\noindent\framebox[\columnwidth][l]{Regressionsgerade}
...
\noindent\framebox[\columnwidth][l]{Kleinste quadratische Abweichung}
...
\section{\noindent\framebox[\columnwidth][l]{Wahrscheinlichkeitstheorie}}
\subsection{\noindent\framebox[\columnwidth][l]{Wahrscheinlichkeitsräume}}

\noindent\framebox[\columnwidth][l]{Der Wahrscheinlichkeitsbegriff}
...
\noindent\framebox[\columnwidth][l]{Elementarereignis}
...
\noindent\framebox[\columnwidth][l]{Laplace-Versuch}
...
\subsection{\noindent\framebox[\columnwidth][l]{Bedingte Wahrscheinlichkeit}}
...
\noindent\framebox[\columnwidth][l]{Formel von Bayes}
\parbox{\columnwidth}{\centering $P(A \vert B) = \frac{P(B \vert A) \cdot P(A)}{P(B)}$}

\noindent\framebox[\columnwidth][l]{Satz der totalen Wahrscheinlichkeit}
\parbox{\columnwidth}{\centering $P(A) = \sum \limits_{i}^n (P(A \vert B_i) \cdot P(B_i)$}

\noindent\framebox[\columnwidth][l]{Allgemeine Regeln}
...
\subsection{\noindent\framebox[\columnwidth][l]{Zufallsvariablen}}
...
\subsection{\noindent\framebox[\columnwidth][l]{Diskrete Verteilungen}}

\noindent\framebox[\columnwidth][l]{Binomialverteilung}
...
\noindent\framebox[\columnwidth][l]{Hypergeometrische Verteilung}
...
\noindent\framebox[\columnwidth][l]{Poisson Verteilung}
...
\noindent\framebox[\columnwidth][l]{Geometrische Verteilung}
...
\subsection{\noindent\framebox[\columnwidth][l]{Stetige Verteilungen}}

\noindent\framebox[\columnwidth][l]{Normalverteilung}
...
\noindent\framebox[\columnwidth][l]{Quantile der Normalverteilung}
...
\subsection{\noindent\framebox[\columnwidth][l]{Erwartungswert und Varianz}}
\subsubsection{\noindent\framebox[\columnwidth][l]{Erwartungswert}}

\noindent\framebox[\columnwidth][l]{Zufallsvariable mit diskreter Verteilung}
\parbox{\columnwidth}{\centering $\mu = E(X) = \sum \limits_{i=0}^n (x_i \cdot p_i)$}

\noindent\framebox[\columnwidth][l]{Zufallsvariable mit Dichtefunktion $f$}
\parbox{\columnwidth}{\centering $\mu = E(X) = \int_{-\infty}^{\infty} x \cdot f(x) dx $}

\noindent\framebox[\columnwidth][l]{Für Binomialverteilung}
\parbox{\columnwidth}{\centering $\mu = E(X) = n \cdot p$}

\noindent\framebox[\columnwidth][l]{Für geometrische Verteilung}
\parbox{\columnwidth}{\centering $\mu = E(X) = \frac{1}{p}$}

\noindent\framebox[\columnwidth][l]{Für Poissonverteilung}
\parbox{\columnwidth}{\centering $\mu = E(X) = \lambda$}

\noindent\framebox[\columnwidth][l]{Für Hypergeometrischeverteilung}
\parbox{\columnwidth}{\centering $E(S_n) = E(X_1 + ... + X_n) = n \cdot E(X_1) = n \cdot \frac{M}{N}$}

\noindent\framebox[\columnwidth][l]{Allgemeine Regeln für den Erwartungswert}
...
\subsubsection{\noindent\framebox[\columnwidth][l]{Varianz}}
...
\noindent\framebox[\columnwidth][l]{Allgemeine Regeln für Varianz}
\parbox{\columnwidth}{\centering $Var(X + Y) = Var(X) + Var(Y) + 2 \cdot cov(X,Y)$}

\subsubsection{\noindent\framebox[\columnwidth][l]{Unabhängiger Zufallsvariablen}}

\noindent\framebox[\columnwidth][l]{Allgemeine Regeln}
\parbox{\columnwidth}{\centering $E(X \cdot Y = E(X) \cdot E(Y)$}
\parbox{\columnwidth}{\centering $Var(X + Y) = Var(X) + Var(Y)$}

\section{\noindent\framebox[\columnwidth][l]{Allgemeine Matheregeln}}
\subsection{\noindent\framebox[\columnwidth][l]{Ableitungen und Integrale}}

\noindent\framebox[\columnwidth][l]{Grundlegende Ableitungsregeln}
...
\noindent\framebox[\columnwidth][l]{Verknüpfte Ableitungsregeln}
\def\arraystretch{1.5}% 
...
\noindent\framebox[\columnwidth][l]{wichtige Stammfunktionen}
\def\arraystretch{1.5}% 
\begin{tabularx}{\columnwidth}{|X|X|}
\cline{1-2}
$f(x)$&$F(x)$\\
