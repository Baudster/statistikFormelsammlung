...
\begin{multicols*}{4}
	...
	\ccontent{$ y = \frac{1}{n}(\sum \limits_{i=1}^r \frac{{h_i}^2}{p_i}) - n$}
	\ccontent{ Das Ergebnis mit $\chi^2_{r-1;1-\frac{P_i}{2}}$ Wert aus der Tabelle vergleichen (erwarteter Wert)}
