...
\begin{multicols*}{4}
	...
	\ccontent{ Die Binomialverteilung kann auch mit der Normalverteilung approximiert werden, wobei gilt $n \cdot p = \mu$ und $n \cdot p \cdot (1-p) = \sigma^2$ \textbf{bedingung ist}}
	...
	\ccontent{ bei unabhängigen Zufallsvariablen $X$ und $Y$ gilt $Cov(X,Y) = 0$ siehe unten.}
