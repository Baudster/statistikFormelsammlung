...
\begin{multicols*}{4}
	...
	\ccontent{ wobei $E(x^2) = \int_{-\infty}^{+\infty} x^2 \cdot f(x) dx$ }
	...
	\ccontent{$f(x_i)$ muss eine Dichtefunktion sein $\Rightarrow$ Wenn $F(x)$ gegeben erst ableiten! }
	...
	\heading{Kapitel 5}
	\subheading{Unterkapitel}
	\subsubheading{$\chi^2$ - Test}
	\ccontent{$ blabla$}
